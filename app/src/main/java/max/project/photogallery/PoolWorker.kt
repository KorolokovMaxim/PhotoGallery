...
class PoolWorker(val context: Context, workerParameters: WorkerParameters)
    ...
    companion object {
        const val ACTION_SHOW_NOTIFICATION = "max.project.photogallery.SHOW_NOTIFICATION"
        const val PERM_PRIVATE = "max.project.photogallery.PRIVATE"
